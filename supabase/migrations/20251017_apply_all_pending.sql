/*
  COMPREHENSIVE MIGRATION - Apply All Pending Schema Updates
  Run this in Supabase SQL Editor to update your database
  
  Includes:
  1. Add sort_order column to menu_items
  2. Add inventory columns (if missing)
  3. Add receipt_url column (if missing)
  4. Add discount pricing columns (if missing)
  5. Add all inventory items
*/
...
-- ============================================
-- 2. ADD DISCOUNT PRICING COLUMNS (IF MISSING)
-- ============================================
...
-- ============================================
-- 3. ADD INVENTORY TRACKING COLUMNS (IF MISSING)
-- ============================================
...
-- ============================================
-- 4. ADD RECEIPT_URL TO ORDERS (IF MISSING)
-- ============================================
...
-- ============================================
-- 5. INSERT CATEGORIES FOR INVENTORY
-- ============================================
...
BEGIN
  ...
  RAISE NOTICE '- sort_order column added';
  RAISE NOTICE '- Discount pricing columns added (if missing)';
  RAISE NOTICE '- Inventory tracking columns added (if missing)';
  RAISE NOTICE '- Receipt URL column added (if missing)';
  RAISE NOTICE '- 5 inventory categories created/updated';
  RAISE NOTICE '- 78 inventory items inserted';
END $$;
